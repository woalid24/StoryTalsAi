...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="py-12 bg-[#150916] h-screen flex justify-center items-center">
        <div className="container  mx-auto">
          <div className="flex max-w-md mx-auto flex-col text-center">
            ...
            <form
              ...
              className="mt-12 mb-8 p-8 bg-[#150916] rounded"
            >
              <span className="text-sm text-gray-400">Sign In</span>
              <h4 className="mb-6 text-3xl text-gray-50">Join our community</h4>
              <div className="flex mb-4 px-4 bg-gray-50 rounded">
                <input
                  className="w-full py-4 text-xs placeholder-gray-400 font-semibold leading-none bg-gray-50 outline-none text-black"
                  type="email"
